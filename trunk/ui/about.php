	...
	<body id="pageBody" class="home">
		...
		<div id="centerDiv">
			...
			<ul>
			 ...
			 target="_blank">Software Engineering</a> project in Winter 2011.  Originally pitched by a team of three, we are now a team of eight working toward the common goal of making WikiMap a great tool for everyone.</p>			 
